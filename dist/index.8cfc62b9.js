...
console.log(data);
console.log('done with fetching'); */ /* const getLastPost = async function () {
...
getLastPost(); */ var _cloneDeepJs = require("./node_modules/lodash-es/cloneDeep.js");
...
(0, _shoppingCartJsDefault.default)("apple \uD83C\uDF4E", 11);
